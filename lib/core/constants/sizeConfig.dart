...
class SizeConfig {
  ...
  /// playing card radius
  static double playingCardRadius = 5.sp;
  ...
  static EdgeInsets get pagePadding {
    return EdgeInsets.symmetric(horizontal: spaceBetween, vertical: 10.sp);
  }
  ...
  /// Returns an [EdgeInsets] object representing the padding to be used for a vertical tile.
   static EdgeInsets get verticalPadding {
    return EdgeInsets.only(bottom: 8.sp);
  }
  /// Returns an [EdgeInsets] object representing the padding to be used for a side tile.
